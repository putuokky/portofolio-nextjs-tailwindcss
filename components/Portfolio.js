        ...
        <div className="w-full px-4 flex flex-wrap justify-center lg:w-10/12 lg:mx-auto">
          <div className="mb-12 p-4 md:w-1/2">
            <div className="rounded-md shadow-md overflow-hidden">
              <Image src="/img/portfolio/1.png" alt="Portfolio 1" layout='responsive' height={400} width={650} />
            </div>
          ...
          <div className="mb-12 p-4 md:w-1/2">
            <div className="rounded-md shadow-md overflow-hidden">
              <Image src="/img/portfolio/2.png" alt="Portfolio 2" layout='responsive' height={400} width={650} />
            </div>
          ...
          <div className="mb-12 p-4 md:w-1/2">
            <div className="rounded-md shadow-md overflow-hidden">
              <Image src="/img/portfolio/3.png" alt="Portfolio 2" layout='responsive' height={400} width={650} />
            </div>
          ...
          <div className="mb-12 p-4 md:w-1/2">
            <div className="rounded-md shadow-md overflow-hidden">
              <Image src="/img/portfolio/4.png" alt="Portfolio 4" layout='responsive' height={400} width={650} />
            </div>
